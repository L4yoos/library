...
@Component
public class LoanReminderEmailFormatter implements EmailContentFormatter<LoanReminderEvent> {

    private static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    @Override
    public String format(LoanReminderEvent event) {
        ...
        String message = "Przypominamy, że termin zwrotu wypożyczonej książki zbliża się!";
